...
function calculateActive(confirmedNumber, deathsNumber, recoveredNumber) {
 const active = deathsNumber + recoveredNumber;
  return Math.floor(confirmedNumber - active);
}